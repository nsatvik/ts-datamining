...
Similarity detection is basically  query time series Q, and some
similarity/dissimilarity measure D(Q;C), find the most similar time series that matches the query series.
\subsubsection{Euclidian Distances}
